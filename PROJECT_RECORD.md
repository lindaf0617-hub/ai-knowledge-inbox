...
4. AI 回答带知识引用
5. AI 生成的新知识可以重新沉淀
6. 已实现的审批式 Knowledge Agent：锁定证据、候选知识、人工批准、审计、撤销与跨设备收敛
...
- 浏览器扩展尚未上架商店
- Agent 不允许无人监督写入正式知识；当前采用候选卡逐条审批
- 外部网页自动搜索尚未开放
...
4. Azure OpenAI 可选模型适配器与企业密钥管理
5. Obsidian Vault 直接导出
6. Agent 外部搜索计划、可信域名与“未验证”知识状态
7. 企业共享空间、ACL、敏感标签与团队审计
